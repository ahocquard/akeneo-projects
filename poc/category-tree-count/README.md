...
I tested queries in ES with big `IN (category_1, category_2)` until 1 million categories. There are 10 millions products (actually very small documents containing only categories).
